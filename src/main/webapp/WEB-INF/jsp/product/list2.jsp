						...
						<c:choose>
							<c:when test="${P.sellstatus=='上架中'&&P.stock>10}">
								<tr>
									...
									<td><a
										href="${contextRoot}/showImformation?id=${P.product_id}"><input
											type="button" value="檢視相關資料"></a> <a
										href="${contextRoot}/addToCart?id=${P.product_id}&quantity=1"><input
											type="button" onclick="return confirm('是否加入購物車?')"
											value="加一個到購物車"></a>
								</tr>
							</c:when>
						</c:choose>
