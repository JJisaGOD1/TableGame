...
<body>
	...
	<header class="header">
		...
		<nav class="navbar" style="left: 11.5vw;">
			...
			<a href="${contextRoot}/">首頁</a> <a href="#about">最新消息</a> 
				 <a href="#products">店鋪資訊</a> <a
				href="${contextRoot}/viewProductsnologin">商品</a> 
				<a href="#" 
				onclick="window.open('http://localhost:8080/homepage/accountProblem', 
						'accountService', config='height=800,width=800');">線上客服</a> 
