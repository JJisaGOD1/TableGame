...
<div class="sidebar">
        ...
        <li>
          <a href="#">
            ...
            <span class="links_name">商品訂單管理</span>
          </a>
        </li>
        <li>
          <a href="${contextRoot}/foodList">
            <i class='bx bxs-bowl-hot' ></i>
            <span class="links_name">餐點管理</span>
          </a>
        </li>
        <li>
          <a href="#">
            ...
            <span class="links_name">餐點訂單管理</span>
          </a>
        </li>
        <li>
          <a href="#">
            <i class='bx bx-book-alt' ></i>
            <span class="links_name">訂位管理</span>
          </a>
        </li>
        <li>
          <a href="#">
            <i class='bx bx-grid-alt' ></i>
            <span class="links_name">開團管理</span>
          </a>
        </li>
        <li>
          <a href="#">
