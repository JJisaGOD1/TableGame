...
<h1>修改訂位</h1>
<table>
<form action="${contextRoot}/editbooking" modelAttribute="editbooking" method="post">

<tr style="display:none">
					<td>ID :<input type="text" name="order_id" value="${booking.id}" >
...
<tr><td>訂位日期：<input type="text" id="datepicker" name="reservation_date" value="${booking.reservation_date}"/></td></tr>
<%-- 					<fmt:formatDate  id="datepicker" path="reservation_date"   pattern="yyyy/MM/dd EEEE" value="${booking.reservation_date}"/></td></tr> --%>
<tr><td>時間：<select name="period" />
							<option>${booking.period}</option>
							<option>上午</option>
							<option>下午</option>
							<option>晚上</option>	
							</select></td></tr>
<tr><td>桌號：<select name="number">
